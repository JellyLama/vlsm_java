...
public class ipv4Address {
    ...
    public ipv4Address(String ip, String subnetMask) {
        ...
        int[] intSplittedIp = {Integer.parseInt(splittedIp[0]), Integer.parseInt(splittedIp[1]),Integer.parseInt(splittedIp[2]), Integer.parseInt(splittedIp[3])};
        this.ip = intSplittedIp;
        
        if (subnetMask.contains(".")) {
            String[] splittedSm = subnetMask.split("\\.");
            int[] intSplittedSm = {Integer.parseInt(splittedSm[0]), Integer.parseInt(splittedSm[1]), Integer.parseInt(splittedSm[2]), Integer.parseInt(splittedSm[3])};
            ...
            //System.out.println(bits);
            int[] intSplittedSm = {Integer.parseInt(splittedSm[0], 2), Integer.parseInt(splittedSm[1], 2), Integer.parseInt(splittedSm[2], 2), Integer.parseInt(splittedSm[3], 2)};
            this.subnetMask = intSplittedSm;
        }
    }
